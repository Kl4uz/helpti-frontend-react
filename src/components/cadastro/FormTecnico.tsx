...
export default function FormTecnico() {
  ...
  const loadEmpresas = async () => {
    try {
      ...
      // Carrega apenas prestadoras de serviço (que podem ter técnicos)
  ...
  const onSubmit = async (data: TecnicoFormData) => {
    try {
      ...
      toast({
        ...
        description: "Sua conta de técnico foi criada com sucesso.",
      });
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-lg animate-fade-in">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-display">Cadastro de Técnico</CardTitle>
            <CardDescription>
              Crie sua conta para atender chamados e gerenciar atividades
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="carlos@prestadora.com"
                  {...register("email")}
                />
                {errors.email && (
              ...
              <div className="space-y-2">
                <Label htmlFor="empresaId">Empresa Prestadora</Label>
